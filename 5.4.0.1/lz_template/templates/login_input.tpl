...
<table cellpadding="0" cellspacing="0" id="lz_form_<!--name-->" class="lz_input">
	<tr>
		...
		<td><input name="form_<!--name-->" class="lz_form_base lz_form_box" maxlength="254" onchange="parent.parent.lz_chat_save_input_value('<!--name-->',this.value);" onkeyup="return parent.parent.lz_chat_save_input_value('<!--name-->',this.value);"></td>
