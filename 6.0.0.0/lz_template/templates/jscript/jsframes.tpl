...
function lz_chat_show_header()
{
    ...
    var hideHeader = width < 250 || lz_chat_data.IsSmall || height < 500 || lz_chat_data.KBOnly;
    var hideLoginHeader = hideHeader || height < 600 || width < 400 || lz_chat_data.CheckoutActive || lz_chat_data.KBOnly;
    ...
    if(lz_chat_get_frame_object('lz_header') != null)
    {
        ...
        if(lz_chat_get_frame_object('lz_chat_login') != null)
        {
            ...
            lz_chat_get_frame_object('lz_chat_login').style.top = (hideLoginHeader && hideHeader) ? (lz_chat_data.KBOnly) ? "0" : "38px" : ((hideLoginHeader) ? "137px" : "217px");
