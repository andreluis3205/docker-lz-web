...
function lz_chat_startup() 
{
	if(lz_chat_data.Groups == null)
	{
        ...
        lz_chat_data.Groups.StatusIcon = !<!--small--> && !<!--rtl-->;
...
function lz_chat_validate_group(_chat)
{
    ...
    if(_chat && lz_chat_data.SelectedGroup.Amount == 0)
    {
        if(<!--function_ticket-->)
            ...
            lz_chat_chat_alert(lz_chat_data.Language.ChatNotAvailable,lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0',''),null,lz_chat_data.Language.LanguageClose,null,true);
        return false;
    }
	return true;
}
...
function lz_chat_goto_message(_inChat,_send)
{
    ...
    if(_inChat)
    {
        ...
        lz_chat_data.PermittedFrames = (lz_chat_data.IECompatible) ? 2 : 1;
...
{
    lz_chat_chat_alert(_setupError,lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0',''),-1,null,null,true);
}
...
function lz_chat_release(_chatPossible, _setupError)
{
	...
	else
	{
        ...
        lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0','lz_tab_ticket').style.display = (<!--function_ticket-->) ? "" : "none";
    ...
    lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0','').document.getElementsByName("form_111")[0].focus();
}
...
function lz_chat_tab_set_active(_application, _userActivity)
{
    try
    {
        ...
        {
            lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0','lz_input_header_box').style.display = 'none';
            lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0','lz_input_header_box').parentNode.style.paddingTop="25px";
        }
        else
        ...
        else
        {
            ...
            lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0','lz_form_details').style.display = (lz_chat_data.ChatGroupAvailable || !<!--function_ticket-->) ? "" : "none";
