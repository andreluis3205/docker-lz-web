...
{
	var getValues = "&b="+lz_global_base64_url_encode(lz_session.BrowserId)+"&pc="+(++lz_poll_id);
...
function lz_tracking_action_result(_action,_result,_closeOnClick,_parameters)
{
	...
	_parameters = "&b="+lz_global_base64_url_encode(lz_session.BrowserId)+"&ue="+lz_global_base64_url_encode(window.location.href) + _parameters;
...
function lz_tracking_add_eye_catcher(_template,_width,_height,_ml,_mr,_mb,_position,_sha,_shb,_shx,_shy,_shc,_sgs,_sge,_sglw,_fgs,_fge,_fi,_fo)
{
    try
    {
