...
function lz_chat_prepare_data_form()
{
    ...
    document.getElementById('lz_chat_overlay_data_form_ok_button').className = (lz_chat_data.CurrentApplication!="chat" || lz_mode_create_ticket) ? "lz_chat_overlay_options_box_base lz_overlay_chat_button unselectable" : "lz_chat_overlay_options_box_base lz_overlay_chat_button lz_overlay_light_button unselectable";

    document.getElementById('lz_chat_overlay_data_form_ok_button').style.right = (document.getElementById("lz_chat_overlay_data_form_cancel_button").style.display == "") ? "140px": "14px";
    ...
    document.getElementById('lz_chat_overlay_data_form_cancel_button').style.left = (document.getElementById("lz_chat_overlay_data_form_ok_button").style.display == "") ? "140px": "14px";
