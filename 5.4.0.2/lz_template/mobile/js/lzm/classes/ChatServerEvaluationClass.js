...
ChatServerEvaluationClass.prototype.addDepartment = function (v) {
    ...
    if (typeof new_department.id != 'undefined') {
        ...
        var userLangName = thisClass.userLanguage;
        var shortUserLangName = userLangName.split('-')[0];
    ...
    $(v).find('tei').each(function () {
        var tei = $(this);
        new_department.tei.push(thisClass.addTei(tei));
    });
...
ChatServerEvaluationClass.prototype.addTei = function (tei) {
    var newTei = {};
