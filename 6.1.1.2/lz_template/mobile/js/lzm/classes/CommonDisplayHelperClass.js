...
CommonDisplayHelperClass.prototype.createCheckbox = function(myId, myLabel, myValue, myClass) {
    return lzm_inputControls.createCheckbox(myId, myLabel, myValue, false ,myClass);
};
