    ...
    if (typeof  group.members != 'undefined' && typeof lzm_chatServerEvaluation != 'undefined') {
        ...
        for (i=0; i<this.oldGroupMembers[group.id].length; i++) {
            ...
            if (membersHasLeft) {
                ...
                if(operator == null)
                {
                    //visitorChat = lzm_chatServerEvaluation.userChats.getUserChat(oldGroupMemberId);
                    ...
                    try{
                        ...
                        /*
                        if(visitorChat!= null && visitorChat.chat_id != ''){
                            console.log("add" + visitorChat.chat_id);
                            lzm_chatDisplay.hiddenChats.push(visitorChat.chat_id);
                        }
                        */
                    }
                    catch(e){
...
LzmVisitors.prototype.getChatBrowser = function(visitorId, browserId) {
    var visitor = this.getVisitor(visitorId), browser = null;
    if (visitor != null && typeof visitor.b != 'undefined') {
        for (var i=0; i<visitor.b.length; i++) {
            if (visitor.b[i].id == browserId) {
                return lzm_commonTools.clone(visitor.b[i]);
            }
        }
    }
    return null;
...
LzmVisitors.prototype.getVisitorName = function(visitor){
    ...
    try{
        ...
        if(typeof visitor.b_chat.fn != 'undefined' && visitor.b_chat.fn!='' && visitor.b_chat.fn!='-')
            name = visitor.b_chat.fn;
        else if(typeof visitor.name != 'undefined' && visitor.name != '' && visitor.name != '-')
            name = visitor.name;
        else if(typeof visitor.cname != 'undefined' && visitor.cname != '' && visitor.cname != '-')
            name = visitor.cname;
    }
    catch(e){}
    return name;
...
LzmUserChats.prototype.setUserChat = function(id, data) {
    ...
    var userChatName = (operator != null) ? operator.name : (group != null) ? group.name : (id == 'everyoneintern') ? t('All operators') : (visitorBrowser[1] != null && visitorBrowser[1].cname != '') ? visitorBrowser[1].cname : (visitor != null) ? visitor.unique_name : id;
    ...
    try
    {
        if (userChat.id != '' && userChat.type == 'external') {
            ...
            if(visitorBrowser != null && visitorBrowser.chat.dgr.length>0){
                return visitorBrowser.chat.dgr;
            }
        }
    }
    catch(e){}
