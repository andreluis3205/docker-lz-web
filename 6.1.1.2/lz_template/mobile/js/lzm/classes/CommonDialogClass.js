...
CommonDialogClass.prototype.changePassword = function(caller, password, callback) {
    ...
    var footerString = lzm_displayHelper.createButton('change-password-ok', 'ui-disabled', '', t('Ok'), '', 'lr',{'margin-left': '6px', 'padding-left': '12px', 'padding-right': '12px', 'cursor': 'pointer'},'',30,'d') +
        lzm_displayHelper.createButton('change-password-cancel', '', '', t('Cancel'), '', 'lr',{'margin-left': '6px', 'padding-left': '12px', 'padding-right': '12px', 'cursor': 'pointer'},'',30,'d');
...
CommonDialogClass.prototype.createDialogWindow = function(headerString, bodyString, footerString, id,
    ...
    htmlContents += '<div id="' + id + '-container" class="dialog-window-container">' +
