...
ChatServerEvaluationClass.prototype.getConfigValue = function(key){
                ...
                try {
                    if (typeof visitor.b[i].chat.pn != 'undefined' && typeof visitor.b[i].chat.pn.member != 'undefined' &&
                        (typeof visitor.b[i].chat.pn.memberIdList != 'undefined' && $.inArray(thisClass.myId, visitor.b[i].chat.pn.memberIdList) != -1)) {
                            ...
                            //lzm_chatDisplay.updateChatMembers(visitor);
                    }
                } catch(e) {}
            }
            for (i=0; i<visitor.b.length; i++) {
        ...
        $(int_d).find('v').each(function () {
            try {
                ...
                //if(typeof newGroup.members != 'undefined')
                  //  lzm_chatDisplay.updateChatMembers(newGroup);
...
ChatServerEvaluationClass.prototype.getTickets = function(xmlDoc, maxRead) {
    ...
    var tlmc = (typeof that.ticketGlobalValues['tlmc'] != 'undefined' && that.ticketGlobalValues['tlmc'] != '') ?
        that.ticketGlobalValues['tlmc'] : 0;
    var elmc = (typeof that.ticketGlobalValues['elmc'] != 'undefined' && that.ticketGlobalValues['elmc'] != '') ?
        that.ticketGlobalValues['elmc'] : 0;
