...
ChatUserActionsClass.prototype.translateTextAndSend = function(visitorChat, chatMessage, chatReco) {
    if(!this.messageFromKnowledgebase){
...
ChatUserActionsClass.prototype.chatInternalWith = function (id, userid, name, fromOpList) {
    ...
    //this.lzm_chatDisplay.updateChatMembers(group);
...
ChatUserActionsClass.prototype.viewUserData = function (id, b_id, chat_id, freeToChat, newlyAcceptedChat) {
    ...
    lzm_chatDisplay.updateChatMembers(thisUser);
...
ChatUserActionsClass.prototype.leaveExternalChat = function (id, b_id, chat_id, chat_no, closeOrLeave) {
    ...
    new_chat.text = t('<!--this_op_name--> has left the chat.',[['<!--this_op_name-->',this.lzm_chatServerEvaluation.myName]]);
...
ChatUserActionsClass.prototype.saveTicketDetails = function(ticket, channel, status, group, editor, language, name,
                                        email, company, phone, message, attachments, comments, customFields, subStatus, subChannel, chat, mc, subject) {
    ...
    if (typeof ticket.id != 'undefined') {
        ...
        this.lzm_chatPollServer.pollServerTicket([{id: id, ne: editor, ns: status, ss: subStatus, sc: subChannel, nch: channel, ng: group, oe: oe, os: os, og: og, nl: language, ol: ol, mc: mc}], [], 'save-details');
    } else {
        this.lzm_chatPollServer.pollServerTicket([{nn: name, nem: email, nc: company, np: phone, nm: message, sub: subject, ne: editor, ns: status, ss: subStatus, sc: subChannel, ng: group, nl: language, nch: channel, at: attachments, co: comments, cf: customFields}], [], 'new-ticket', chat);
    }
};
