...
var createLoginForm = function(profileIndex, userStatus) {
    ...
    var loginForm = lzm_displayHelper.createInput('username', 'login-input', '', 'Username', '<i class="fa fa-user"></i>', 'text', 'a') +
        ...
        lzm_displayHelper.createSelect('user_status', '', '', true, false, {background: '#888', border: '2px solid #fff', width: '90px', color: '#fff', 'border-radius': '0px','border-bottom-left-radius': '14px', 'border-top-left-radius': '14px', padding: '6px 0 6px 12px'}, '', optList, userStatus,'') +
        lzm_displayHelper.createButton('login_btn', 'ui-disabled', '', t('Log in'), '', 'r', {'padding': '7px 15px'}, '', 'd') +
        lzm_displayHelper.createButton('orientation_btn', '', '', '', '<i class="fa fa-rotate-right"></i>', 'lr', {'padding': '7px 15px'}, '', 'b') +
    ...
    if (runningFromApp) {
        ...
        loginForm += lzm_displayHelper.createButton('configure_btn', '', '', '', '<i class="fa fa-gear"></i>', 'lr', {'padding': '7px 15px'}, '', '');
