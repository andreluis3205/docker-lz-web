...
var createConfigurationForm = function(selectedIndex, configFormMode) {
    ...
    var configureForm = '<div id="profile-selection-div">' +
        ...
        lzm_displayHelper.createButton('new_profile_btn', '', '', '', '<i class="fa fa-plus"></i>', 'lr',{'padding-left': '15px', 'padding-right': '15px'}, '', 'e') +
        '</span><span style="padding: 16px 2px;" onclick="editProfileOnclickAction();">' +
        lzm_displayHelper.createButton('edit_profile_btn', 'change-config ui-disabled', '', '', '<i class="fa fa-gear"></i>', 'lr',  {'padding-left': '15px', 'padding-right': '15px'}, '', 'e') +
        '</span><span style="padding: 16px 2px;" onclick="delProfileOnclickAction();">' +
        lzm_displayHelper.createButton('del_profile_btn', 'change-config ui-disabled', 'delProfileOnclickAction();', '', '<i class="fa fa-minus"></i>', 'lr', {'padding-left': '15px', 'padding-right': '15px'}, '', 'e') +
        '</span>' +
        '</div>' +
        ...
        lzm_displayHelper.createButton('save_profile', '', '', t('Save profile'), '', 'lr', {display: 'none', padding:'3px 15px'}, '', 'd') +
        lzm_displayHelper.createButton('back_btn', '', '', t('Ok'), '', 'lr', {padding:'3px 15px'}, '', 'd') +
        '</div>';
...
var createProfileForm = function(type, profileData) {
    ...
    if (type != 'empty') {
        ...
        profileForm = lzm_displayHelper.createInput('profile-name', '', profileName, t('Profile Name'), '', 'text', 'a') +
            ...
            lzm_displayHelper.createInput('username', loginDataClass + ' top-space-half', profileUserName, t('Username'), '<i class="fa fa-user"></i>', 'text', 'a') +
